      ...
      <div className="w-full relative lg:left-[200px] md:left-10 left-10">
        ...
        <div className="my-10 ml-10 mr-8">
          ...
          <div className=" lg:flex md:flex grid gap-5 items-center ">
              ...
              <Link  to="/Allsales" className="border-blue-300 rounded-md border-2 lg:w-[150px]  md:w-[150px] w-[90px] h-[40px]  py-2 text-center font-semibold">
              All sales
              </Link>
...
export default Standalonesales;