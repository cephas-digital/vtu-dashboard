    ...
    <div className="flex bg-[#f8f7f7] min-h-screen">
      ...
      <div className="w-full relative lg:left-[200px] md:left-20 left-20 ">
        ...
        <div className="my-10 ml-10 mr-8">
          {/* Header */}
            ...
            <div className=" lg:flex md:flex grid gap-5 items-center ">
                            <h3 className="font-bold py-2">Outgoing</h3>
                            ...
                            <Link to="/Incomingnotifications"  className="border-blue-300 rounded-md  pl-2 border-2 lg:w-[550px] md:w-[290px] w-[100px] h-[40px]  py-2 font-semibold">
                            Incoming
                            </Link>
                            </div>
        ...
        {/* User List Table */}
          ...
          <div className="grid  grid-cols-4 text-center py-3 lg:w-[1050px] md:w-[1200px] w-[900px]  rounded-md text-[grey] font-semibold">
