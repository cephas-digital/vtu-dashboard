    ...
    <div className="flex bg-[#f8f7f7] min-h-screen">
      ...
      <div className="w-full relative lg:left-[200px] md:left-20 left-20">
        ...
        <div className=" lg:flex md:flex grid gap-5 items-center ml-10 mt-10">
                    ...
                    <Link  to="/Allusers" className="border-blue-300 rounded-md border-2 lg:w-[150px]  md:w-[150px] w-[100px] h-[40px]  py-2 text-center font-semibold">
                    All-users
                    </Link>
                    <Link to = "/afiliates" className="border-blue-300 rounded-md  pl-4 border-2 lg:w-[650px] md:w-[390px] w-[95px] h-[40px]  py-2 font-semibold">
                      Affiliates
                    </Link>
